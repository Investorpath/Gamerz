const words = [
    'السعود', 'العراق', 'الكويت', 'المغرب', 'الجزائر', 'تونسية', 'ليبيين', 'مصرية', 'سودان', 'لبنان',
    'فلسطين', 'سوريا', 'يمنية', 'عمانية', 'قطرية', 'بحرين', 'اردنية', 'طائرة', 'سفينة', 'قطارات',
    'سيارة', 'دراجه', 'منزل', 'بستان', 'حديقة', 'مدرسة', 'جامعة', 'مكتبة', 'مستشفى', 'شارع',
    'ميدان', 'مدينة', 'قرية', 'جزيرة', 'شلال', 'غابات', 'رمال', 'صحراء', 'سحابة', 'امطار',
    'ثلوج', 'رياح', 'شمسية', 'نجوم', 'قمري', 'كوكب', 'فضاء', 'عالم', 'تاريخ', 'ثقافة'
];
